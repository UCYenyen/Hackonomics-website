...
export default function Header() {
  ...
  return (
    <header className="bg-[#464141] border-b-2 border-[#AC5654] sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14">
          {/* Logo */}
          <Link href="/" className="flex items-center">
            <div className="w-8 h-8 bg-[#AC5654] rounded flex items-center justify-center">
              <span className="text-[#F5F0F6] font-bold text-xl font-mono">F</span>
            </div> 
