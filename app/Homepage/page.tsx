              ...
              <div className="bg-[#464141] rounded-lg p-6">
                <div className="prose prose-sm max-w-none">
                  ...
                  <ul className="text-[#F5F0F6] space-y-1 mb-4">
                    <li>• Manage multiple income streams and investments</li>
                    <li>• Make strategic financial decisions that impact your empire</li>
                    <li>• Unlock new business opportunities as you grow</li>
                    <li>• Experience authentic 8-bit pixel art and chiptune music</li>
                  </ul>

                  <h3 className="text-[#AC5654] font-mono text-lg mb-2">
                    💼 Kuasai Manajemen Keuangan
                  </h3>
                  <p className="text-[#F5F0F6] mb-4">
